...
Module* makeLLVMModule() {
 ...
 // Type Definitions
 ArrayType* ArrayTy_0 = ArrayType::get(IntegerType::get(mod->getContext(), 8), 96);
...
GlobalVariable* gvar_array_undo_log = new GlobalVariable(/*Module=*/*mod, 
/*Type=*/ArrayTy_0,
/*isConstant=*/false,
...
ConstantAggregateZero* const_array_11 = ConstantAggregateZero::get(ArrayTy_0);
Constant *const_array_12 = ConstantDataArray::getString(mod->getContext(), "%d", true);
ConstantInt* const_int64_13 = ConstantInt::get(mod->getContext(), APInt(64, StringRef("-16"), 10));
...
ConstantInt* const_int64_16 = ConstantInt::get(mod->getContext(), APInt(64, StringRef("1639"), 10));
Constant* const_ptr_17 = ConstantExpr::getCast(Instruction::BitCast, gvar_array_undo_log, PointerTy_6);
ConstantInt* const_int64_18 = ConstantInt::get(mod->getContext(), APInt(64, StringRef("1638"), 10));
...
ConstantInt* const_int64_22 = ConstantInt::get(mod->getContext(), APInt(64, StringRef("32"), 10));
const_ptr_20_indices.push_back(const_int64_22);
Constant* const_ptr_20 = ConstantExpr::getGetElementPtr(gvar_array_undo_log, const_ptr_20_indices);
Constant* const_ptr_19 = ConstantExpr::getCast(Instruction::BitCast, const_ptr_20, PointerTy_6);
std::vector<Constant*> const_ptr_23_indices;
const_ptr_23_indices.push_back(const_int64_21);
const_ptr_23_indices.push_back(const_int64_21);
Constant* const_ptr_23 = ConstantExpr::getGetElementPtr(gvar_array_undo_log, const_ptr_23_indices);
...
// Function: __prev_store_exists (func___prev_store_exists)
{
 ...
 CastInst* ptr_25 = new BitCastInst(ptr_loc, PointerTy_6, "", label_entry);
 ...
 PHINode* ptr_loc_pn = PHINode::Create(PointerTy_5, 2, "loc.pn", label_while_cond);
 ptr_loc_pn->addIncoming(ptr_loc, label_entry);
 ptr_loc_pn->addIncoming(fwdref_27, label_while_body);
 
 GetElementPtrInst* ptr_curr_0 = GetElementPtrInst::Create(ptr_loc_pn, const_int64_13, "curr.0", label_while_cond);
 ICmpInst* int1_cmp = new ICmpInst(*label_while_cond, ICmpInst::ICMP_ULT, ptr_curr_0, ptr_begin, "cmp");
 BranchInst::Create(label_return, label_while_body, int1_cmp, label_while_cond);
 
 // Block while.body (label_while_body)
 CastInst* ptr_29 = new BitCastInst(ptr_curr_0, PointerTy_6, "", label_while_body);
 ...
 ICmpInst* int1_cmp1 = new ICmpInst(*label_while_body, ICmpInst::ICMP_EQ, int64_30, int64_31, "cmp1");
 BranchInst::Create(label_return, label_while_cond, int1_cmp1, label_while_body);
 ...
 fwdref_27->replaceAllUsesWith(ptr_curr_0); delete fwdref_27;
...
// Function: main (func_main)
{
 ...
 BasicBlock* label_entry_34 = BasicBlock::Create(mod->getContext(), "entry",func_main,0);
 
 // Block entry (label_entry_34)
 StoreInst* void_35 = new StoreInst(const_int64_16, const_ptr_17, false, label_entry_34);
 void_35->setAlignment(16);
 StoreInst* void_36 = new StoreInst(const_int64_18, const_ptr_19, false, label_entry_34);
 void_36->setAlignment(16);
 std::vector<Value*> int32_call_params;
 int32_call_params.push_back(const_ptr_23);
 int32_call_params.push_back(const_ptr_20);
 CallInst* int32_call = CallInst::Create(func___prev_store_exists, int32_call_params, "call", label_entry_34);
 ...
 CallInst* int32_call4 = CallInst::Create(func_printf, int32_call4_params, "call4", label_entry_34);
